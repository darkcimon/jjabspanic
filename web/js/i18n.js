...
const dict = {
  ko: {
    ...
    'market.item.repelCharm.desc': '다음 스테이지 시작 시 {pct}% 확률로 15초간 몬스터가 플레이어를 피해 달아난다 (구매마다 +1%p, 최대 {max}%)',
  ...
  en: {
    ...
    'market.item.repelCharm.desc': '{pct}% chance monsters flee from you for 15s at the start of the next stage (+1%p per purchase, max {max}%)',
