...
const dict = {
  ko: {
    ...
    'market.item.gatherCharm.desc': '다음 스테이지 시작 시 {pct}% 확률로 15초간 몬스터를 플레이어 쪽으로 끌어당긴다. 몬스터 회피의 부적과 함께 쓰면 캐릭터 바로 바깥에 뭉치게 되어 총·칼로 한 번에 처치하기 좋다 (구매마다 +1%p, 최대 {max}%)',
  ...
  en: {
    ...
    'market.item.gatherCharm.desc': '{pct}% chance monsters get pulled toward you for 15s at the start of the next stage. Combine with the Repel Charm to bunch them up just outside your reach for an easy gun/sword sweep (+1%p per purchase, max {max}%)',
