...
const dict = {
  ko: {
    ...
    // 악세사리 — 레벨(최고 스테이지) 50/100 이상부터 마켓 악세사리 탭에서 단계적으로
    // 해금. 카테고리(모자/옷/악세사리/신발)당 하나만 착용 가능하며, 각각 작은 상시
    // 효과가 붙는다(accessories.js 참고).
    'accessory.locked': '레벨 {level} 이상부터 악세사리를 구매할 수 있어요 (최고 스테이지 기준)',
    'accessory.itemLocked': 'Lv.{level}부터 해금',
    'accessory.fullSetHint': '✨ 모자·옷·악세사리·신발을 모두 착용하면 포인트 획득 +5% 추가!',
    ...
    'accessory.item.hat_bow.desc': '필드 아이템 등장 빈도 +10%',
    'accessory.item.outfit_scarf.name': '포근한 목도리',
    'accessory.item.outfit_scarf.desc': '피격 후 무적시간 +0.5초',
    'accessory.item.acc_sunglasses.name': '멋쟁이 선글라스',
    'accessory.item.acc_sunglasses.desc': '스테이지 클리어 포인트 +5%',
    'accessory.item.shoes_sneakers.name': '깜찍한 운동화',
    'accessory.item.shoes_sneakers.desc': '이동속도 +5%',
    'accessory.item.shoes_rocket.name': '로켓 부츠',
    'accessory.item.shoes_rocket.desc': '이동속도 +12%',
    'accessory.item.acc_wings.name': '요정 날개',
    'accessory.item.acc_wings.desc': '스테이지 클리어 포인트 +12%',
    'accessory.item.outfit_cape.name': '영웅의 망토',
    'accessory.item.outfit_cape.desc': '최대 목숨 +1',
    'accessory.item.hat_crown.name': '황금 왕관',
    'accessory.item.hat_crown.desc': '필드 아이템 등장 빈도 +25%',
  ...
  en: {
    ...
    'accessory.itemLocked': 'Unlocks at Lv.{level}',
    'accessory.fullSetHint': '✨ Wear a hat, outfit, accessory and shoes together for +5% bonus points!',
    ...
    'accessory.item.hat_bow.desc': '+10% field item spawn rate',
    'accessory.item.outfit_scarf.name': 'Cozy Scarf',
    'accessory.item.outfit_scarf.desc': '+0.5s invincibility after getting hit',
    'accessory.item.acc_sunglasses.name': 'Cool Sunglasses',
    'accessory.item.acc_sunglasses.desc': '+5% points on stage clear',
    'accessory.item.shoes_sneakers.name': 'Cute Sneakers',
    'accessory.item.shoes_sneakers.desc': '+5% move speed',
    'accessory.item.shoes_rocket.name': 'Rocket Boots',
    'accessory.item.shoes_rocket.desc': '+12% move speed',
    'accessory.item.acc_wings.name': 'Fairy Wings',
    'accessory.item.acc_wings.desc': '+12% points on stage clear',
    'accessory.item.outfit_cape.name': "Hero's Cape",
    'accessory.item.outfit_cape.desc': '+1 max life',
    'accessory.item.hat_crown.name': 'Golden Crown',
    'accessory.item.hat_crown.desc': '+25% field item spawn rate',
