...
const dict = {
  ko: {
    ...
    'market.item.petUpgrade.desc': '펫이 스스로 자동 발사를 시작·강화한다 ({to}/{max}단) — 10단: 직선, 50단: 부채꼴, 100단: 유도탄, 150단: 발사 속도 증가, 200단: 총알 크기 확대',
  ...
  en: {
    ...
    'market.item.petUpgrade.desc': "Makes your pet auto-fire and upgrades it ({to}/{max}) — Lv.10: straight shot, Lv.50: spread shot, Lv.100: homing missile, Lv.150: faster fire rate, Lv.200: bigger bullets",
