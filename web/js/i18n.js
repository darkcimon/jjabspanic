...
const dict = {
  ko: {
    ...
    'market.pbAutoModeUpgraded': '🤖🎯 오토모드 강화 완료 (초당 4발, 게임 중 하단 버튼으로 켜기/끄기)',
  ...
  en: {
    ...
    'market.pbAutoModeUpgraded': '🤖🎯 Auto Mode Upgrade equipped (4 shots/sec, toggle with the bottom button in-game)',
