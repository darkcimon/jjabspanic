...
const dict = {
  ko: {
    ...
    'help.how.controls.body': '<li><b>이동</b> — 방향 버튼 또는 화면 스와이프</li><li><b>칼 사용</b> — Z키 또는 아이템 버튼 탭</li><li><b>총 사용</b> — X키 또는 아이템 버튼 탭</li><li><b>번개</b> — 번개 버튼 탭 후 화면 터치</li>',
    ...
    'help.items.gun.desc': 'X키 또는 탭으로 발동. 탄환 10발 (중첩 시 최대 30발). 진행 방향으로 발사',
    ...
    'market.item.swordLevelUp.desc': '칼 단계 업그레이드 ({to}/100)',
    'market.unitLevel': '{n}단',
    'market.item.gun.name': '총',
    'market.item.gun.desc': 'X키로 총알 5발 발사',
  ...
  en: {
    ...
    'help.how.controls.body': '<li><b>Move</b> — D-pad or swipe the screen</li><li><b>Use sword</b> — Z key or tap the item button</li><li><b>Use gun</b> — X key or tap the item button</li><li><b>Lightning</b> — tap the lightning button, then touch the screen</li>',
    ...
    'help.items.gun.desc': 'Activate with X or tap. 10 bullets (up to 30 when stacked), fired in your facing direction',
    ...
    'help.market.legend.body': '<li>⚔️ <b>Sword</b> (30,000pt) — Z/tap to kill enemies on your line (requires 2+ lives)</li><li>🗡️ <b>Divine Sword</b> (30,000pt) — sword upgrade: more range and power (shown once you own a sword)</li><li>🔫 <b>Gun</b> (30,000pt) — X/tap to fire 5 bullets</li><li>🔫 <b>Ammo ×5</b> (10,000pt) — +5 bullets (shown once you own a gun)</li><li>⚡ <b>Lightning</b> (10,000pt) — tap the lightning button then touch the screen for a 3×3 strike. Stackable</li><li>🌩️ <b>Zeus\'s Lightning</b> (15,000pt) — a massive 5×5 lightning strike, wider than regular lightning. Stackable</li>',
    ...
    'market.item.swordLevelUp.desc': 'Sword level up ({to}/100)',
    'market.unitLevel': 'Lv.{n}',
    'market.item.gun.name': 'Gun',
    'market.item.gun.desc': 'Fire 5 bullets with X',
