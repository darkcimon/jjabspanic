...
const dict = {
  ko: {
    ...
    'market.item.repelCharm.desc': '다음 스테이지 시작 시 15초간 몬스터가 플레이어를 피해 달아난다 (보유 {count}개)',
    'market.item.freezeCharm.name': '시간 동결의 부적',
    'market.item.freezeCharm.desc': '다음 스테이지 시작 시 5초간 몬스터가 완전히 멈춘다 (보유 {count}개)',
  ...
  en: {
    ...
    'market.item.repelCharm.desc': 'At the start of the next stage, monsters flee from you for 15s (you have {count})',
    'market.item.freezeCharm.name': 'Freeze Charm',
    'market.item.freezeCharm.desc': 'At the start of the next stage, monsters freeze completely for 5s (you have {count})',
