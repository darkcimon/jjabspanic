...
const dict = {
  ko: {
    ...
    'market.item.autoMode.desc': '영구 1회 구매. 게임 중 하단 버튼으로 켜고 끌 수 있으며, 켜져 있으면 선택된 총 또는 칼을 1초에 4발씩 자동으로 사용한다. 켜진 상태에서 적을 모두 처치하면 점령률과 무관하게 즉시 스테이지 클리어',
  ...
  en: {
    ...
    'market.item.autoMode.desc': 'One-time permanent buy. Toggle on/off with the bottom button in-game; while on, automatically fires your selected gun or sword 4 times per second. While on, clearing every enemy instantly clears the stage regardless of fill rate',
